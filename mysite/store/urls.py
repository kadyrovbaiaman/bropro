...
urlpatterns=[
    ...
    path('users/<int:pk>/',UserProfileViewSet.as_view({'get': 'retrieve',
                                                       'put': 'update','delete':'destroy'}),name='userprofile_detail'),
    ...
    path('rating/', RaitingViewSet.as_view({'get': 'list', 'post': 'create'}), name='rating_list'),
    path('rating/<int:pk>/', RaitingViewSet.as_view({'get': 'retrieve',
    ...
    path('car_items/',CarItemViewSet.as_view({'get':'list','post':'create'}),name='car_item_list'),
    path('car_items/<int:pk>/',CarItemViewSet.as_view({'put':'update','delete':'destroy'}))
